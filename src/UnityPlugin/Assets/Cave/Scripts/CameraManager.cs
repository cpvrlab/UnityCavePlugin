...
#region "private vars"
        ...
        void Start()
        {
            ...
            _viewInfo.Add(0, new ViewInfo { Left = _cameraLeftLeft, Right = _cameraLeftRight, CAVESide =  new CAVEPlanesettings { name = "left", center = new Vector3(_main.CaveDimensions.lHeight / 2, 0f, 0f), normal = _main.CAVELeft.normal, height = _main.CaveDimensions.lHeight, width = _main.CaveDimensions.lWidth, CAVESide = _main.CAVELeft } });
                                                                                                                                                                                                //lwidth = distance
            _viewInfo.Add(1, new ViewInfo { Left = _cameraFrontLeft, Right = _cameraFrontRight, CAVESide =  new CAVEPlanesettings { name = "front", center = new Vector3(0f, _main.CaveDimensions.lWidth / 2), normal = _main.CAVEFront.normal, height = _main.CaveDimensions.fHeight, width = _main.CaveDimensions.fWidth, CAVESide = _main.CAVEFront  } });
            _viewInfo.Add(2, new ViewInfo { Left = _cameraRightLeft, Right = _cameraRightRight, CAVESide = new CAVEPlanesettings { name = "right", center = new Vector3(_main.CaveDimensions.rHeight / 2, 0f, 0f), normal = _main.CAVERight.normal, height = _main.CaveDimensions.rHeight, width = _main.CaveDimensions.rWidth, CAVESide = _main.CAVERight } });
            _viewInfo.Add(3, new ViewInfo { Left = _cameraBottomLeft, Right = _cameraBottomRight, CAVESide = new CAVEPlanesettings { name = "bottom", center = new Vector3(0f, _main.CaveDimensions.bHeight / 2,  0f), normal = _main.CAVEBottom.normal, height = _main.CaveDimensions.bHeight, width = _main.CaveDimensions.bWidth, CAVESide = _main.CAVEBottom } });
