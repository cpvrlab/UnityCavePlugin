...
public class Frustum : MonoBehaviour {
    ...
    public static Matrix4x4 GeneralizedPerspectiveProjection(Vector3 bottomLeft, Vector3 bottomRight, Vector3 topLeft, Vector3 headTrackerLocation, float near, float far)
    {
        Vector3 va, vb, vc;
        Vector3 vr, vu, vn;
